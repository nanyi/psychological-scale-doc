...
| 错误码 | 说明 | 对应枚举 |
|--------|------|----------|
| 1000 | 系统错误 | `SYSTEM_ERROR` |
| 1005 | Token已过期 | `TOKEN_EXPIRED` |
| 1006 | Token无效 | `TOKEN_INVALID` |
| 1007 | 刷新Token失败 | `REFRESH_TOKEN_FAILED` |

### 9.3 会话管理错误码（1100-1199）

| 错误码 | 说明 | 对应枚举 |
|--------|------|----------|
| 1100 | 会话不存在 | `SESSION_NOT_FOUND` |
| 1101 | 踢出会话失败 | `SESSION_KICK_FAILED` |
| 1102 | 无权踢出会话 | `SESSION_NO_PERMISSION` |
| 1103 | 会话已离线 | `SESSION_OFFLINE` |
| 1104 | 会话已过期 | `SESSION_EXPIRED` |

### 9.4 登录策略错误码（1200-1299）

| 错误码 | 说明 | 对应枚举 |
|--------|------|----------|
| 1200 | 登录策略不存在 | `STRATEGY_NOT_FOUND` |
| 1201 | 更新登录策略失败 | `STRATEGY_UPDATE_FAILED` |
| 1202 | 无权修改登录策略 | `STRATEGY_NO_PERMISSION` |

### 9.5 登录日志错误码（1300-1399）

| 错误码 | 说明 | 对应枚举 |
|--------|------|----------|
| 1300 | 登录日志不存在 | `LOG_NOT_FOUND` |
| 1301 | 查询登录日志失败 | `LOG_QUERY_FAILED` |
